...
const NAV: { label: string; items: NavItem[] }[] = [
  {
    label: 'FactorHub',
    items: [
      { href: '/dashboard', icon: 'fa-house', label: 'Visão Geral', match: (p) => p === '/dashboard' || p === '/dashboard/' },
      { href: '/dashboard/agentes', icon: 'fa-robot', label: 'Agentes IA', badge: 'AI', badgeColor: '#7C3AED' },
      { href: '/dashboard/uso', icon: 'fa-chart-bar', label: 'Consumo & Custo' },
    ],
  },
  {
    label: 'Operação',
    items: [
      ...
      { href: '/dashboard/clientes', icon: 'fa-users', label: 'Clientes & Leads' },
      { href: '/dashboard/eventos', icon: 'fa-calendar-star', label: 'Eventos' },
      { href: '/dashboard/conteudo', icon: 'fa-pen-nib', label: 'Conteúdo' },
    ],
  },
]

const TITLES: Record<string, string> = {
  '/dashboard': 'FactorHub — Visão Geral',
  '/dashboard/agentes': 'Agentes IA',
  '/dashboard/uso': 'Consumo & Custo de Tokens',
  '/dashboard/projetos': 'Projetos',
  '/dashboard/ideias': 'Ideias',
  '/dashboard/clientes': 'Clientes & Leads',
